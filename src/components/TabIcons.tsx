/**
 * 탭바 아이콘 — raising-client `shared/ui/icon/Icons.tsx`의 SVG를 1:1 포팅(웹과 동일).
 * 활성 #292929 / 비활성 #CFCFCF (웹 동일). 흰 디테일은 white 유지.
 */
...
export const IconHome = ({ selected, size = 26 }: TabIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 26 26" fill="none">
    <Path
      ...
      fill={selected ? ACTIVE : INACTIVE}
    />
  </Svg>
);

export const IconMap = ({ selected, size = 26 }: TabIconProps) => (
...
export const IconCommunity = ({ selected, size = 26 }: TabIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 26 26" fill="none">
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const IconUser = ({ selected, size = 26 }: TabIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 26 26" fill="none">
    <Circle cx="13" cy="6" r="4" fill={selected ? ACTIVE : INACTIVE} />
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
